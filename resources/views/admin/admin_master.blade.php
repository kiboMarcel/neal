...
<html lang="en">
  <head>
    ...
    <meta name="description" content="kibo">
    <meta name="author" content="kibo">
    <meta name="robots" content="kibo">

    <!-- Open Graph Meta -->
    <meta property="og:title" content="kibo">
    <meta property="og:site_name" content="kibo">
    <meta property="og:description" content="Kibo - ">
  ...
  <body>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
      ...
      <aside id="side-overlay">
        <!-- Side Header -->
        <div class="bg-image" style="background-image: url('backend/assets/media/various/bg_side_overlay_header.jpg');">
          <div class="bg-primary-op">
            <div class="content-header">
              <!-- User Avatar -->
              <a class="img-link me-1" href="be_pages_generic_profile.html">
                <img class="img-avatar img-avatar48" src="{{ asset('backend/assets/media/avatars/avatar10.jpg')}}" alt="">
              </a>
              <!-- END User Avatar -->
                  ...
                  <div class="block-content">
                    <ul class="nav-items">
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="{{ asset('backend/assets/media/avatars/avatar8.jpg')}}" alt="">
                      ...
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="{{ asset('backend/assets/media/avatars/avatar2.jpg')}}" alt="">
                            <span class="overlay-item item item-tiny item-circle border border-2 border-white bg-success"></span>
                          </div>
                          <div class="flex-grow-1">
                  ...
                  <div class="block-content">
                    <ul class="nav-items">
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="{{ asset('backend/assets/media/avatars/avatar7.jpg')}}" alt="">
                  ...
                  <div class="block-content">
                    <ul class="nav-items">
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="{{ asset('backend/assets/media/avatars/avatar15.jpg')}}" alt="">
                      ...
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="{{ asset('backend/assets/media/avatars/avatar5.jpg')}}" alt="">
                            <span class="overlay-item item item-tiny item-circle border border-2 border-white bg-warning"></span>
                          </div>
                          <div class="flex-grow-1">
                  ...
                  <div class="block-content">
                    <ul class="nav-items">
                      ...
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="{{ asset('backend/assets/media/avatars/avatar4.jpg')}}" alt="">
                            <span class="overlay-item item item-tiny item-circle border border-2 border-white bg-muted"></span>
                          </div>
                          <div class="flex-grow-1">
