...
@section('admin')
    ...
    <div class="content">
        <h2 class="content-heading">Modifier Equipment</h2>
        <div class="row push">

            <div class="col-lg-10">
                <!-- Form Grid -->
                <form  method="post" action=" {{ route('equipment.update',$editData->id ) }} " enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-4">
                        <div class="col-4">
                            <label class="form-label" for="nom">Nom</label>
                            <input type="text" class="form-control" value="{{$editData->nom}}"
                             id="nom" required name="nom"
                               >
                        </div>
                        <div class="col-4">
                            <label class="form-label" for="mobile">Unité</label>
                            <input type="integer" class="form-control" id="unite" value="{{$editData->unite}}" 
                            required name="unite"
                               >
                        </div>
                        <div class="col-4">
                            <label class="form-label" for="mobile">Prix Unitaire</label>
                            <input type="double" class="form-control" id="prix_unitaire" value="{{$editData->prix_unitaire}}" 
                            required name="prix_unitaire"
                               >
                        </div>
                        <div class="col-4">
