...
@section('admin')
    ...
    <div class="content">
        ...
        <div class="table-responsive">
            <div class="head">
                <h2 class="content-heading">Categotie de produit </h2>
                    ...
                    @foreach ($allData as $key => $category)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href=" {{ route('category.product.edit', $category->id) }} " type="button"
        ...
        <div class="modal fade" id="modal-block-popin" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin"
            ...
            <div class="modal-dialog modal-dialog-popin" role="document">
                <div class="modal-content">
                    <form method="post" action=" {{ route('category.product.delete', 'id') }} ">
                        @csrf
                        @method('GET')
